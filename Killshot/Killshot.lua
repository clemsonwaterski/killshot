-- settings ==============================================================================================================
	local version = "v8.00 (19-07-2018)";
	local version_nr = "8000";
...
-- load vars & start addon ===============================================================================================
	...
	function kshotFrame:OnEvent(event)
		if (event == "ADDON_LOADED") then
			...
			local PrefixRegistered = C_ChatInfo.RegisterAddonMessagePrefix(Prefix);
...
-- needed crap ===========================================================================================================
	function kshot:OnEnable()
		kshot:SoundEventHandler();
		--self:RegisterEvent("CHAT_MSG_ADDON");
		--self:SetScript("OnEvent", kshot:AddonMessageHandler);
		local frame = CreateFrame("Frame");
		frame:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED");
		frame:SetScript("OnEvent", function()
			kshot:CombatLogEventHandler(CombatLogGetCurrentEventInfo())
		end);
		--self:RegisterEvent("ZONE_CHANGED_NEW_AREA");
		--self:SetScript("OnEvent", kshot:ZoneChangedHandler);
	end
...
-- main script ===========================================================================================================
	...
	-- share data ========================================================================================================
		-- send & receive event ========================================================================
			...
			function kshot:SendAddonMessage(data, share_channel)
				C_ChatInfo.SendAddonMessage(Prefix, data, share_channel);
	...
	-- combat events =====================================================================================================
		function kshot:CombatLogEventHandler(timestamp, event, hideCaster, sourceGUID, sourceName, sourceFlags, sourceRaidFlags, destGUID, destName, destFlags, destRaidFlags, ...)
			kshot:checkPlayerName();
